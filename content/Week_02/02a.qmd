...
```{r, echo=F}
knitr::include_graphics(here('images','Econ-social-event-flyer-2024.png'), error=F)
```
...
I have set up a Zoom room with a short link: [bit.ly/EC242](bit.ly/EC242). It shouldn't require a password, but if it does, it's GOGREEN
