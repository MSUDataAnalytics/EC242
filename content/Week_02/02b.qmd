...
Compare each account's quietest hour against its busiest, and the three come
apart immediately.
...
dents it --- 38 posts on a weekday, 29 on a Saturday. A wire service with staff
in every time zone looks exactly like that from the outside.
