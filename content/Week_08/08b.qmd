...
### Its just a dummy....
We've noticed that most of the blue dots (with manual transmission) have higher `mpg`. We have a dummy in our data. Let's see what it does if we use it as our only variable:

::: {.callout-note}
## TRY IT

1. Calculate the mean mpg conditional on `am==1` and on `am==0`. This is our sample estimate of what *population* concept?
