...
It's the latter! While readers can guesstimate the murder *rate* from total murders and population, it's a lot better to *show* them the murder rate in the first place. We do that below.
