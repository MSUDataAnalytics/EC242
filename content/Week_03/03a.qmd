...
5. Viewers eyes will follow a predictable path. Visual cues serve to light up that path. 

6. The representation of numbers, as physically measured on the surface of the graph itself, should be directly proportional to the numerical quantities represented. 

7. Empty space is informative. Do not fill every inch, but let the absence of information guide the viewer.

8. When possible (and in a visually suitable way), show the data.
