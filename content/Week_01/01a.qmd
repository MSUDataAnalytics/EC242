...
#| fig-alt: "Flyer promoting MSU Applied Econ study abroad program. Image 1 of 2 shows a group of 20 students standing in front of an old building. Image 2 of 2 shows a skyline view of downton London."
knitr::include_graphics(here('images','London–Summer 2026-Info Session Flyer.png'))
```
...
#| fig-alt: "Image shows a map of US showing state-level murder rates per 100k people. Louisiana and Missouri are highest at 6+, while the upper west/midwest and upper New England areas are lowest"
...
murders %>% mutate(murder_rate = total/population*10^5,
  ...
  scale_fill_brewer(labels = c('<1','1-2','2-3','3-4','4-5','6+')) +
  theme_minimal()
rm(fifty_states)
```
...
### Let's review the [syllabus](/syllabus/)
