...
But first...who likes ice cream? [RSVP Here](https://bit.ly/4mHSsil)

```{r, echo=F, out.width='80%'}
knitr::include_graphics(here('images','2025_IceCream.png'))
```
...
For one participation point, please email me {{< var email.instructor >}} with the subject *[EC242] Who Dis* (use exactly this subject!). In the message, tell me:
