...
booking_raw = read_csv(here('data','Travel_booking.csv'))
roomrates_raw = read_csv(here('data','Travel_roomrates.csv'))
parking_raw = read_csv(here('data','Travel_parking.csv'))
