...
```{r, echo = T, eval = F}
unemployment = read.csv('https://EC242.netlify.app/data/unemployment.csv')
str(unemployment)
```
...
library(tidyverse)
str(read_csv('https://EC242.netlify.app/data/unemployment.csv'))
```

```{r, echo=F, message = FALSE, warning = FALSE}
library(tidyverse)
str(read_csv(here('data','unemployment.csv')))
```
...
Our TA has emailed everyone their group assignemnts. Thus, everyone should be assigned to a group by now. If you did not get a group assignment let me know **right now**. The TA's email asked you to make contact / meet with your group by Sunday. Please make sure you do so. As TA Zach mentioned, if you do not hear from a group member by Sunday, let me know.
