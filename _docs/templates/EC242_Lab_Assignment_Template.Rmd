...
```{r}
# code goes here; replace this code
a = 'hello world'
print(a)
```
...
## 2. Text of next question copied here. etc. (delete if there isn't one)
...
You're on your own for the structure here on out. When you make a new section with the two or three hashtags (pound signs) followed by a space, they have to be at the beginning of the line - no spaces before them. Check your work. Delete this sentence before rendering your final PDF or you'll receive 1 point off.
