...
newsrooms and one person.

```{r posting-clock, echo=FALSE, out.width="100%"}
knitr::include_graphics(here('images','posting-clock.png'))
```

Three organisations, three completely different animals.

The **Associated Press** never sleeps. Look along the 3am column --- it is nearly
as busy as 3pm, and Saturday looks like Tuesday. That is what a wire service
with staff in every timezone looks like from the outside.

The **New York Times** clearly has a working week. Weekends are visibly darker
and there is a hard spike around noon.

**George Takei** --- one man, 1.3 million followers --- goes quiet before 7am and
after about 6pm, with a bright band in the early afternoon. That is not a man
firing off thoughts as they occur to him. That is a job, and quite possibly
somebody else's.

None of that came from asking anyone anything. It came from 21,000 timestamps
and about forty lines of code, which you can
...
By the end of this course you will --- the whole thing is `read_csv`, a timezone
conversion, `count`, and `geom_tile`, and you will meet all four of those before
October.
