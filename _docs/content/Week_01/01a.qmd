...
We've now covered a short bit of material. The remainder of this first lecture will be covering setting up `R` and describing some common errors. For this, we'll head over to [resources](/resource/) to install R and RStudio. If you leave class without a working installation of these pieces of software, then you are likely to run into trouble in completing your first assignments.
