...
For one participation point, please email me [jkirk@msu.edu](mailto:jkirk@msu.edu) with the subject *[EC242] Who Dis*. In the message, tell me:
...
- People interact with people to form outcomes we care about
  ...
  - Thus **EC**242
  - But also, forming institutions (PoliSci), social movements and norms (sociology), spatial patterns (hello, Geo folks), interactions with natural resources (coupled human-natural systems), etc.
