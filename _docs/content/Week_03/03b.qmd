...
Now that add-drop has passed, it's time to set groups. **If you have found 2 other people to form a 3-person group**, then please do the following by this Saturday night at 11:59pm:

- Nominate **one** person in your group to e-mail myself {{< var email.instructor >}} **AND** {{< var names.TA >}} at {{< var email.TA >}} with the subject **[EC242] Groups**.
...
On Sunday, our TA will assign all remaining students to a group. *No changes will be made and there is no room for late group formation.* You will recieve an email letting you know your group assignment on or before Tuesday.
