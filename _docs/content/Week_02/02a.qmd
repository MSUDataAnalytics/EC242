...
A somewhat quicker way to write this code is to specify which column will **not** be pivot_longered, rather than all the columns that will be pivot_longered:
