...
About fifteen minutes. Steal the colour palette from the figure above --- it's in
the source of this page, and stealing a palette that works is a perfectly
...
3. Right now your states are in alphabetical order, which tells the reader
   nothing. Use `reorder()` to sort them by how many cases they've had.

4. Label it properly. Someone should be able to read the title and know what
   they're looking at without you standing next to them.
...
switching to a rate change which three states you pointed at?
