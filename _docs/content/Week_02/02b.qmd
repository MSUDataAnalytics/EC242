...
The **Associated Press** barely has a night. Nineteen percent of everything it
posts goes out between midnight and 6am, and the weekend only dents it --- 38
posts on a weekday, 29 on a Saturday. A wire service with staff in every time
zone looks exactly like that from the outside.

The **New York Times** posts *more* than the AP does in this window, and yet
its shaded band is nearly empty: 8 percent overnight, against the AP's 19. The
weekend is the sharper tell --- 63 posts on a weekday, 37 on a Saturday. The
vertical streaks are days when something happened.

**George Takei** --- one man, 1.3 million followers --- has the shape of a
person with a schedule. Almost nothing runs before 10am or after 9pm Pacific,
and Saturdays are half-off (15 posts a weekday, 7 on a weekend day). That is
not a man firing off thoughts as they occur to him. That is a job, and quite
