...
We have a lot of potential X-values here, so we don't just make a scatterplot (what would we put on the X axis?). But we can plot a histogram of this just to see what we're up against:
