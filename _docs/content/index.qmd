...
::: {.callout-note}
## Two weeks are exceptions this term
Fall Break falls on Tuesday, October 27 and Thanksgiving on Thursday, November
26, so those two weeks have a single meeting each rather than two. The schedule
marks both. Everything else follows the usual Tuesday/Thursday rhythm.
:::
