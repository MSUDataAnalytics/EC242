...
A histogram and qq-plot confirm that the normal approximation is accurate as well. A qq-plot simply plots the observed quantile values (for quantiles 1-100 usually) agains the *theoretical* quantiles from a normal distribution with the same mean and standard error (from the sample's SD):
