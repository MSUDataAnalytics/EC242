...
**For this week, you need to start making your plots look nice. For full credit, you will have to label axes, label the plot, and experiment with themes. Experiment with adding a `labs()` layer or changing colors. Use colorblind-friendly colors.** Make sure all plots are legible and neat. If you're super brave, try modifying a theme and its elements. Default plots will not receive full credit.
