...
- [<i class="fas fa-file-csv"></i> `roomrates.csv`](/data/Lab_roomrates.csv) - Contains the price of each room on each day. The Lab version of this data is from our German affiliate, so pay attention to the date format, and be careful -- it's very wide, so using `head` will throw a lot of data at you.
