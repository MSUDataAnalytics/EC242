...
- ✔−: (*4 points (50%) in gradebook*) Work is hastily composed, too short, poorly formatted without headers, and/or only cursorily engages with the course content. This grade signals that you need to improve next time. I will hopefully not assign these often.
...
- ✔+: (*17.5 points (115%) in gradebook*) Exercises are complete. Every task was attempted and answered, and all answers are correct in detail. Knitted document is clean and easy to follow. Work on the final problem shows creativity or is otherwise exceptional. We will not assign these often.
- ✔: (*15 points (100%) in gradebook*) Exercises are complete and most answers are correct. Document is correctly formatted with few minor formatting errors. This is the expected level of performance.
- ✔−: (*7.5 points (50%) in gradebook*) Exercises are less than 70% complete and/or most answers are incorrect. Document is poorly formatted without appropriately rendered headers. This indicates that you need to improve next time. We will hopefully not assign these often.
- 0: (*0 points (0%) in gradebook*) Exercises are less than 50% complete, are grossly incorrect, or clearly do not follow the questions. Knitted document is not rendered via latex to PDF.
