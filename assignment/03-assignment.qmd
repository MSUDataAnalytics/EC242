...
Now, use an apprpriate `facet` function (wrap or grid) to re-make this plot across each `CATEGORY`. Again, make sure everything is labeled well and properly formatted.
