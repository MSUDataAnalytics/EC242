...
For Exercise 3, use this [data on MI county-level income, age, population, and commute time](data/milong.csv), which can be loaded using the following line of code to directly create the object in your code chunk:
