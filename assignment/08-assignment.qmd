...
The function `na.omit` takes a data.frame and drops all rows in which there is one or more `NA`. So if you have a lot of variables and they have lots of `NA`s, you may lose a lot of rows. Let's try it:
