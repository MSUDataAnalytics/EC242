...
Note to Ben (S26 onward): I've moved this entire unit on histograms, densities, the normal distribution, and basic geometries (barplot, etc.) to a resource and replaced it with...something.
