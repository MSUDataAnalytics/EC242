...
- [**R Graph Gallery**](https://r-graph-gallery.com/): R code for hundreds of ggplot graphs.
- [**Emery's Essentials**](http://annkemery.com/essentials/): Descriptions and examples of 26 different chart types.

## MSU-offered resources {#datavis-resources}
- [**MSU Data Vis Library Page**](https://libguides.lib.msu.edu/datavis)
