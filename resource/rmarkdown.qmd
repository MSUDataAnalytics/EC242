...
knitr::include_graphics(here('images','knit-button.png'))
```
...
knitr::include_graphics(here('images','insert-chunk-button.png'))
```
...
You can specify what kind of document you create when you knit in the [YAML front matter](/resource/markdown.html#front-matter). 
...
Whether you have the file on your hard drive already, right-click and download from the web to keep a copy for posterity, or save the image from a screenshot, you will often need to insert an image from a local file. In Rmarkdown, the path will always be *relative to the folder containing your .Rmd file*. So if you keep your .Rmd in `/Users/yourname/EC242/Example3` and you have a folder `/Users/yourname/EC242/Example3/images` that contains a file `picture.png`, then you would tell Rmarkdown to find the file at `./images/picture.png` (which implies its filepath is `/Users/yourname/EC242/Example3/images/picture.png`). The `./` tells R to start looking in the local directory holding the .Rmd file you're working on.
