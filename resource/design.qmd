...
- [**Coblis**](https://www.color-blindness.com/coblis-color-blindness-simulator/): Simulate how your images look for people with different forms of colorblindness (web-based)
...
- [**Colorpicker for data**](http://tristen.ca/hcl-picker/): More fancy mathematical rules for color palettes ([explanation](https://www.vis4.net/blog/avoid-equidistant-hsv-colors/)).
