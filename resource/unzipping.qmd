...
knitr::include_graphics(here("images","unzip-mac.png"), error = FALSE)
```
...
knitr::include_graphics(here("images","inside-zip-windows.png"), error = FALSE)
```
...
```{r, echo=FALSE, out.width="60%"}
knitr::include_graphics(here("images","temp-wd-windows.png"), error = FALSE)
```
...
```{r, echo=FALSE, out.width="60%"}
knitr::include_graphics(here("images","extract-windows-1.png"), error = FALSE)
```

Then choose where you want to unzip all the files and click on "Extract"

```{r, echo=FALSE, out.width="60%"}
knitr::include_graphics(here("images","extract-windows-2.png"), error = FALSE)
```
...
```{r, echo=FALSE, out.width="60%"}
knitr::include_graphics(here("images","extract-windows-3.png"), error = FALSE)
```
