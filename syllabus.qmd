...
<!-- Note for Ben: I bumped up participation so it's now 6% of the grade (30 points, 5 points each for the first 6, then 1 point each (1/5th of a percent each) for additional up to 5 more points).  -->
