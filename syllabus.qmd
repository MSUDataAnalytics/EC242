...
### Course Structure
Here's how each week will work: before class on Tuesday, you'll read the first entry under [content](/content/) for the week -- the first is more geared towards "principles" and the second toward "applications" and are labeled as such on our [course schedule](/schedule.html). On Tuesday, you'll come to lecture. Before Thursday, you'll read the second [content](/content/) entry for the week, and on Thursday you'll come to lecture ready to participate with a charged laptop. On Saturday night by 11:59pm, you'll turn in your [Weekly Writing assignment](/assignment/#weekly-writings) responding to the weekly writing prompt **given during class on Tuesday or Thursday**, rendered to PDF by RMarkdown and using the proper template (see [assignments](/assignment)). By Monday at 11:59pm, you'll turn in your [Lab assignment](/assignment/#labs), also using the RMarkdown template. 
