...
### Rounding
All grades are first calculated as a percent, then rounded to the nearest whole integer. These are mapped to MSU grades using the following rubric. There are no exceptions or special rounding favors.
...
All grade ranges are applied after rounding off to the nearest integer. Please do not ask for special rounding favors. There are many ways to gain extra points in this class via participation. Place your efforts there.
