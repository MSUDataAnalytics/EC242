...
`4.0` Turned in all assignments with excellent effort, showed exceptional mastery of the tools on all projects, and participated extensively.
...
We are a sizable class, so participation points will be awarded using EC slips which you will be able to turn into me (with your name on it) at the end of class. That way, I don't slow down the class trying to write down everyone's names. Each of the slips is worth one percentage point of your grade in participation (e.g. if participation is 6% of your grade, you need to earn 6 to get full participation credit). If you go beyond that (and I hope you do), each slip is worth 1/5th of the credit, with a cap of 5 percentage points of extra credit.
