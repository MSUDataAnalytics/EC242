...
library(scales)
un = fread('https://ec242.netlify.app/data/unemployment.csv') %>%
  dplyr::mutate(date_format = as.Date(date))

ggplot(un, aes(x = date_format, y = unemployment, group = state)) +
  geom_line() +
  # scale_x_date(date_breaks = '3 years', date_labels = '%Y') +
  scale_x_date(breaks =date_breaks('5 year') , date_labels = '%b %Y') +
...
ggplot(un, aes(x = date, y = unemployment)) +
  geom_line() +
  # scale_x_date(date_breaks = '3 years', date_labels = '%Y') +
